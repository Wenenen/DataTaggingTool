...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.keyword.setGeometry(QtCore.QRect(250, 250, 281, 51))
        font = QtGui.QFont()
        font.setPointSize(22)
        self.keyword.setFont(font)
        self.keyword.setObjectName("keyword")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(560, 50, 220, 61))
        ...
        self.backLabel.setGeometry(QtCore.QRect(210, 140, 491, 71))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.soso_btn.setText(_translate("mainWindow", "相似(2)"))
